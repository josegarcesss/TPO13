...
public class TPO13 {
    ...
    public static void main(String[] args) {
        ...
        int alumno[]=new int[3];
        int materia[]=new int[4];
//        try{
...
//            miStatement.setInt(2, alumno[0]);
//            miStatement.setInt(3,materia[0]);
//            ResultSet miResulset=miStatement.executeQuery();
//            miResulset=miStatement.getGeneratedKeys();
//            if(miResulset.next()){
//                System.out.println(miResulset.getInt(1));
...
//            miStatement.setInt(2, alumno[0]);
//            miStatement.setInt(3,materia[1]);
//            ResultSet miResulset=miStatement.executeQuery();
//            miResulset=miStatement.getGeneratedKeys();
//            if(miResulset.next()){
//                System.out.println(miResulset.getInt(1));
...
//            miStatement.setInt(2, alumno[1]);
//            miStatement.setInt(3,materia[2]);
//            ResultSet miResulset=miStatement.executeQuery();
//            miResulset=miStatement.getGeneratedKeys();
//            if(miResulset.next()){
//                System.out.println(miResulset.getInt(1));
...
//            miStatement.setInt(2, alumno[2]);
//            miStatement.setInt(3,materia[3]);
//            ResultSet miResulset=miStatement.executeQuery();
//            miResulset=miStatement.getGeneratedKeys();
//            if(miResulset.next()){
//                System.out.println(miResulset.getInt(1));
